...
import (
	...
	"gitee.com/zhaochuninhefei/fabric-config-gm/cfssl/crypto/pkcs7"
...
func ParsePrivateKeyPEMWithPassword(keyPEM []byte, password []byte) (key crypto.Signer, err error) {
	return PEMToSm2PrivateKey(keyPEM, password)
...
func PEMToSm2PrivateKey(raw []byte, pwd []byte) (*sm2.PrivateKey, error) {
	...
	if !ok {
		return nil, errors.New("cfssl/helpers/helpers.go PEMToSm2PrivateKey : pem is not sm2 privatekey")
	}
	return key, nil
}
